...
groups.insert(dict(location_id=1, day=1, time_start="15:00", time_end="17:00",
                         days="1 3 4", teacher=1))

groups.insert(dict(location_id=2, day=1, time_start="10:00", time_end="12:00",
                         days="2 4 5", teacher=2))
groups.insert(dict(location_id=2, day=1, time_start="10:00", time_end="12:00",
                         days="3", teacher=3))
groups.insert(dict(location_id=2, day=1, time_start="15:00", time_end="17:00",
                         days="4 5", teacher=3))


groups.insert(dict(location_id=3, day=1, time_start="10:00", time_end="12:00",
                         days="1 3", teacher=2))
groups.insert(dict(location_id=3, day=1, time_start="15:00", time_end="17:00",
                         days="1 2", teacher=4))
groups.insert(dict(location_id=3, day=1, time_start="14:30", time_end="16:30",
                         days="5", teacher=4))

groups.insert(dict(location_id=4, day=1, time_start="15:00", time_end="17:00",
                         days="1 2 3 4 5", teacher=5))

groups.insert(dict(location_id=5, day=1, time_start="9:00", time_end="17:00",
                         days="1", teacher=6))
groups.insert(dict(location_id=5, day=1, time_start="10:00", time_end="12:00",
                         days="3", teacher=6))
groups.insert(dict(location_id=5, day=1, time_start="15:00", time_end="17:00",
                         days="3 4 5", teacher=6))

groups.insert(dict(location_id=6, day=1, time_start="13:00", time_end="15:00",
                         days="6", teacher=1))
